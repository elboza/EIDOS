...
void movewind(char num)
{
 ...
 char *buff,*elfabx1,*elfabx2,*elfaby1,*elfaby2;
 int nx,loc,sp1,sp2;
 unsigned int n,m;
 unsigned char xx;
 elfabx1=(char *)malloc(80*2);
 elfabx2=(char *)malloc(80*2);
 elfaby1=(char *)malloc(80*2);
 elfaby2=(char *)malloc(80*2);
...
int menusec(char num,char mode)
{
